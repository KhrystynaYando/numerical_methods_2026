...
# Вона використовується для побудови інтерполяційного
# многочлена Ньютона.
...
# ==========================================================
# Обчислюємо значення FPS при 1000 об'єктах
# двома методами (Ньютон і Лагранж)
...
# ==========================================================
# Перебираємо значення кількості об'єктів і визначаємо
# найбільше, при якому FPS не менше 60.
...
# ==========================================================
# При великій кількості рівновіддалених вузлів
# многочлен високого степеня починає коливатись
# на краях інтервалу (ефект Рунге).
...
# ==========================================================
# Показуємо, як змінюється абсолютна похибка
# вздовж усього досліджуваного інтервалу.
